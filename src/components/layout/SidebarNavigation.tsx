...
function NavIcon({ name }: { name: NavItem["icon"] }) {
  const paths: Record<NavItem["icon"], React.ReactNode> = {
    ...
    features: <path d="m12 3 2.2 4.8L19 10l-4.8 2.2L12 17l-2.2-4.8L5 10l4.8-2.2L12 3Zm7 11 1 2 2 1-2 1-1 2-1-2-2-1 2-1 1-2Z" />,
    ...
    webhooks: <path d="M12 6a4 4 0 1 1-4 4M6 18a4 4 0 1 1 4-4M18 18a4 4 0 1 1-4-4" />,
    keys: <path d="M21 2 13.6 9.4M15 6l3 3M9 15a4 4 0 1 1-5.7 5.7A4 4 0 0 1 9 15Z" />,
    events: <path d="M5 4h14v16H5zM8 8h8M8 12h8M8 16h5" />,
    logs: <path d="M4 5h16M4 10h16M4 15h10M4 20h7" />,
    settings: <path d="M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm7.4-3.5a7.9 7.9 0 0 0-.1-1l2-1.6-2-3.4-2.5 1a8 8 0 0 0-1.7-1L14.7 3h-4l-.4 2.9a8 8 0 0 0-1.7 1L6.1 6l-2 3.4 2 1.6a8 8 0 0 0 0 2l-2 1.6 2 3.4 2.5-1a8 8 0 0 0 1.7 1l.4 2.9h4l.4-2.9a8 8 0 0 0 1.7-1l2.5 1 2-3.4-2-1.6a7.9 7.9 0 0 0 .1-1Z" />,
  };
...
export function SidebarNavigation({ applications }: { applications: ApplicationSummary[] }) {
  ...
  return (
    <aside className="sidebar sidebar-p1">
      ...
      <div className="sidebar-context-card" aria-label="Application context">
      ...
      <nav className="sidebar-nav sidebar-nav-p1">
        {navSections.map((section, sectionIndex) => (
          <div key={section.label ?? `primary-${sectionIndex}`} className="sidebar-section">
